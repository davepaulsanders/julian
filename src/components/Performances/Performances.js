...
export const Performances = () => {
  ...
  return (
    <div id="performances" className="w-full md:w-8/12 mb-40">
      <h2 className="performances-title text-4xl my-5">PERFORMANCES</h2>
      <div className="event-box flex flex-col w-11/12 md:w-full text-left mt-2 mb-6 mx-2 border-b border-black pb-4 short-event">
      <div className="flex items-center">
        ...
        <p className="event-description hidden-event mt-4 w-full lg:w-3/4">
          ...
          series from 7pm to 8pm. Registration is not required for this event.
