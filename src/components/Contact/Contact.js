  ...
  return (
    ...
    >
      <div className="w-full md:w-8/12 flex flex-col items-center">
        <h2 className="section-title contact-title text-slate-200 text-5xl pb-10 pl-4 self-start relative">CONTACT</h2>
        <form className="flex flex-col w-11/12 md:w-8/12 xl:w-6/12">
          <label className="text-xl text-left text-slate-200" htmlFor="email">
            Email
          </label>
          <input type="text" id="email" className="mb-2 p-2 shadow-inner" />
